...
[Piraeus Silo for Azure](https://github.com/skunlab/piraeus) is the
open source, Orleans silo for running the Piraeus communications system.

This chart bootstraps Piraeus Silo for Azure in your Kubernetes cluster.
