...
namespace Piraeus.SiloHost.Core
{
    class Program
    {
        ...
        private static void CreateClusteredSiloHost()
        {
            ...
            {               
                //silo.UseRedisMembership(tableLogger, options => options.ConnectionString = "piraeus.redis.cache.windows.net:6380,password=y4fGNTZkH+NI2Msz0yiH8Q+WFICgE1yO1FKysaL97oA=,ssl=True,abortConnect=False");
